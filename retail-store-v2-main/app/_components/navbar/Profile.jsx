          ...
          <ListGroup>
            <ListGroup.Item className={"listGroupItem"}>
              <div className="d-flex flex-row">
                <img
                  src="/rsc/icons/circle-user-solid.svg"
                  alt="Logo"
                  width={18}
                  className="me-1"
                />
                <div
                  onClick={() => console.log("selectedUser: ", selectedUser)}
                >
                  <p className={"textMyProfile"}>My Profile</p>
                  <small>
